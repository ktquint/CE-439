...
ggplot() +
  ...
  labs(title = "Corrección de Caudales Retrospectivos", color = "Fuente de Datos") +
...
ggplot() +
  ...
  facet_wrap(~ Mes, scales = 'free_y') + # the y-axis on each plot changes with its data
...
forecast <- forecast.correction(forecast.file, correccion.de.sesgo)
...
ggplot(data=forecast) +
  ...
  labs(x = "Fecha", y = "Flow (cms)", title = "Caudales Pronósticos Corregidos", color = "Fuente de Datos") +
